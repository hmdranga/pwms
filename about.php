...
<html lang="en">
    ...
    <head>
        ...
        <title>e-Printing Shop - About</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row align-items-center my-5">
                <div class="col-lg-7">
                    <img class="img-fluid rounded mb-4 mb-lg-0" src="images/20746159_259753994529674_7903619762336935137_o.jpg" alt="">
                </div>
                <!-- /.col-lg-8 -->
                <div class="col-lg-5">
                    <h1 class="font-weight-light">The D Ads Digital </h1>
                    <p>Mainly focus Customer service, high-quality printing and state-of-the-art technology are given utmost priority, at The D Ads Digital & Offset Printing.</p>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            <img class="img-fluid rounded mb-4 mb-lg-0" src="images/71397347_696241364214266_293151300571365376_n.jpg" alt="">                        </div>
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            <img class="img-fluid rounded mb-4 mb-lg-0" src="images/72523728_712155782622824_3589415610783629312_o.jpg" alt=""> 
                        </div>
